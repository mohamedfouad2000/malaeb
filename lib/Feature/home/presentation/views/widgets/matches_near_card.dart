...
import 'package:malaeb/Feature/home/presentation/views/widgets/soccer_match_deatils.dart';

class MatchesNearCard extends StatelessWidget {
  const MatchesNearCard({super.key});
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: defaultButton(
                    fun: () {
                      NavegatorPush(context, const SoccerMatchDeatils());
                    },
                    textWidget: Text(
                      "join us",
